...
import john_doe_portfolio_website from "../assets/john_doe_portfolio_website/hero_section.png";
      ...
      <div className="project_page_container">
        ...
        <figure className="project_page_figure">
          <img
            ...
            src={john_doe_portfolio_website}
        ...
        <div>
          ...
          <a
            className="project_page_link"
            href="github.com/HrushikeshJoshi187/john_doe_Portfolio_Website"
            target="_blank"
            rel="noopener noreferrer"
          >
