export default function Hero() {
  return (
    <section className="w-full min-h-[100vh] px-4 sm:px-8 md:px-12 mx-auto xl:max-w-6xl flex flex-col justify-center gap-2 md:gap-4 overflow-hidden break-normal">
